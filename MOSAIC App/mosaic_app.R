      ...
      mainPanel(
        tabsetPanel(
          ...
          tabPanel("Welcome to MOSAIC",
            ...
            tags$p(HTML("For more information on the format of your data, please click the corresponding '?' buttons. Examples of this data are available in the MOSAIC application download folder. For explanations for what specific terms mean, click the '?' buttons to their right. Recommendations are also made in the '?' text. Please note: in order to download results, you must open this app in the browser window before starting to run. Also note: preprocessing has various effects on output. This is discussed futher in the supplement of <a href='https://academic.oup.com/bioinformatics/article-abstract/36/3/773/5544107?redirectedFrom=fulltext'>De los Santos, et al. (2020)</a>.")),
            ...
            tags$p(HTML("If you are using the results from this app or want to learn about its methods, please <a href='https://academic.oup.com/bioinformatics/advance-article-abstract/doi/10.1093/bioinformatics/btaa877/5922811?redirectedFrom=fulltext'>cite us</a>.")),
            ("If you run into any errors, please email hurlej2@rpi.edu with the following (subject line: MOSAIC Error):"),tags$br(),
