      ...
      mainPanel(
        tabsetPanel(
          ...
          tabPanel("Welcome to MOSAIC",
            ...
            tags$p(HTML("If you are using the results from this app or want to learn about its methods, please cite us.")),
          ...
          tabPanel("Interpreting MOSAIC Result Files",
            ...
            ("- Phase Shift (RNA or protein): Parameter describing the amount the oscillator is shifted, in radians. Used in ECHO, ECHO Joint, ECHO Linear, and ECHO Linear Joint models."),tags$br(),
            ("- Hours Shifted (RNA or protein): Desribes the amount the oscillator is shifted in hours, calculated from phase shift and fitted period. This is the time of the first peak of the oscillation, relative to 0 as determined by the time course entered by the user. Used in ECHO, ECHO Joint, ECHO Linear, and ECHO Linear Joint models."),tags$br(),
            ...
            ("- Fitted_TPX.R (RNA or protein): ECHO's fitted data for time point (TP) X, and replicate R."),tags$br(),tags$br(),
